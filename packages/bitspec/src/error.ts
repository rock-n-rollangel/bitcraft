export type BitspecErrorCode =
  ...
  | "INVALID_FIELD_NAME"   | "UNKNOWN_COUNT_FIELD" | "INVALID_COUNT_FIELD"
  | "DYNAMIC_ARRAY_NOT_AT_TAIL" | "MULTIPLE_DYNAMIC_ARRAYS"
  | "READ_OUT_OF_BOUNDS"   | "TOO_MANY_BITS_READ"  | "PACKET_TOO_SHORT"
  | "WRITE_OUT_OF_BOUNDS"  | "INVALID_VALUE"       | "MISSING_FIELD"
  | "UNSUPPORTED_VALUE"    | "COUNT_MISMATCH"      | "COUNT_OVERFLOW"
