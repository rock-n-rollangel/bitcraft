...
Not published to crates.io. These bindings ship as the [`bitspec`](https://www.npmjs.com/package/bitspec) npm package; to use them from Rust, depend on this crate by git or path, or build it with `wasm-pack build --target web`.
